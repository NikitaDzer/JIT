...
static const unsigned long long PRINTF_LG_SPECIFIER  = INITIAL_RSP_STORAGE  + sizeof(unsigned long long);
static const unsigned long long SCANF_LG_SPECIFIER   = PRINTF_LG_SPECIFIER  + sizeof(unsigned long long);
